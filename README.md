![](https://github.com/enmerk4r/Swiftlet/blob/main/Assets/Logo/Logo_Readme.png)
...
## Questions?
Check out the [Wiki](https://github.com/enmerk4r/Swiftlet/wiki)!
...
The current packaging pipeline can emit both `rh8` and `rh9` Yak distributions from the same Rhino 8 shell while that binary remains compatible in Rhino 9.
