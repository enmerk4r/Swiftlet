...
internal static class ShellIcons
{
    ...
    public static Bitmap? For(Type componentType)
    {
        string fileName = componentType.Name switch
        {
            ...
            "CreateMultipartFormBodyNamedComponent_ARCHIVED" => "Icons_create_multipart_form_data_named_24x24.png",
            "CreateMultipartFormBodyUnnamedComponent_ARCHIVED" => "Icons_create_multipart_form_data_unnamed_24x24.png",
            "CreateQueryParamComponent" => "Icons_create_query_param_24x24.png",
            "CreateTextBodyComponent_ARCHIVED" => "Icons_create_text_body_24x24.png",
            ...
            "SocketListenerComponent_ARCHIVED" => "Icons_socket_listener_24x24.png",
