...
[Obsolete("Archived legacy component. Use the current Create Text Body component.")]
public sealed class CreateTextBodyComponent_ARCHIVED : GH_Component
{
    ...
    public CreateTextBodyComponent_ARCHIVED()
    ...
    public override Guid ComponentGuid => new("87D53FB2-BA5D-46DC-BC7B-92EAC5AEBC6C");
